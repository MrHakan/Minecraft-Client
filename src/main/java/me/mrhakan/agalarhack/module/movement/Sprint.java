...
public class Sprint extends Module {
    ...
    public void onUpdate() {
        ...
        // main's omni option, on this branch's ownership model. Sideways and backward count as
        // moving only when it is on; otherwise this is the forward-impulse test it always was.
        boolean moving;
        if (getBooleanSetting("omni", false)) {
        ...
        // main still tests the bare flag; that is the regression this branch already fixed.
        ...
        // this client does not do. That also makes main's per-tick write suppression moot: nothing
        // here writes a state it has already written.
        if (shouldSprint) {
    ...
    /** main reset its cached state on disconnect; here that is exactly what onDisable already does. */
    @Override
