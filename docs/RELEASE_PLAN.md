...
- The last code-bearing CI run executes 798 JUnit tests with zero failures/errors/skips, all client
  game-test entrypoints, runtime mixin verification, addon fixture containment, generated docs and
  artifact creation.
